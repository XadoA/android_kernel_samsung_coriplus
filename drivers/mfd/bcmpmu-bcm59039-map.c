...
/* Comparators control reg */
	...
	[PMU_REG_HV8OPMODCTRL] =	{.map = 0x00, .addr = 0xA9, .mask = 0xFF, .ro = 0},
	[PMU_REG_HV9OPMODCTRL] =	{.map = 0x00, .addr = 0xAA, .mask = 0xFF, .ro = 0},
	[PMU_REG_HV10OPMODCTRL] =	{.map = 0x00, .addr = 0xAB, .mask = 0xFF, .ro = 0},
	[PMU_REG_SIMOPMODCTRL] =	{.map = 0x00, .addr = 0xAC, .mask = 0xFF, .ro = 0},
	[PMU_REG_CSROPMODCTRL] =	{.map = 0x00, .addr = 0xAD, .mask = 0xFF, .ro = 0},
	...
	[PMU_REG_HVLDO5CTRL] =		{.map = 0x00, .addr = 0xB7, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO6CTRL] =		{.map = 0x00, .addr = 0xB8, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO7CTRL] =		{.map = 0x00, .addr = 0xB9, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO8CTRL] =		{.map = 0x00, .addr = 0xBA, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO9CTRL] =		{.map = 0x00, .addr = 0xBB, .mask = 0x07, .ro = 0},
	[PMU_REG_HVLDO10CTRL] =		{.map = 0x00, .addr = 0xBC, .mask = 0x07, .ro = 0},
	[PMU_REG_SIMLDOCTRL] =		{.map = 0x00, .addr = 0xBD, .mask = 0x07, .ro = 0},
	[PMU_REG_PWR_GRP_DLY] =		{.map = 0x00, .addr = 0xBE, .mask = 0xFF, .ro = 0},
	...
	[PMU_REG_ASRCTRL1] =		{.map = 0x00, .addr = 0xD8, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL2] =		{.map = 0x00, .addr = 0xD9, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL3] =		{.map = 0x00, .addr = 0xDA, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL4] =		{.map = 0x00, .addr = 0xDB, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL5] =		{.map = 0x00, .addr = 0xDC, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL6] =		{.map = 0x00, .addr = 0xDD, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL7] =		{.map = 0x00, .addr = 0xDE, .mask = 0xFF, .ro = 0},
	[PMU_REG_ASRCTRL8] =		{.map = 0x00, .addr = 0xDF, .mask = 0xFF, .ro = 0},
	...
	[PMU_REG_HSPUP_HS_PWRUP] =	{.map = 0x01, .addr = 0xAB, .mask = 0x40, .ro = 0, .shift = 6},
	...
	[PMU_REG_IHFPOP_EN] =	{.map = 0x01, .addr = 0x83, .mask = 0x04,
				 .ro = 0, .shift = 2},
	[PMU_REG_IHFDRVCLAMP_DIS] =	{.map = 0x01, .addr = 0x8C, .mask = 0x08,
				 .ro = 0, .shift = 3},
	...
	[PMU_REG_CHRGR_EOC] =		{.map = 0x00, .addr = 0x58, .mask = 0x0F, .ro = 0, .shift = 0},
	/* fuel gauge */
	[PMU_REG_FG_ACCM0] =		{.map = 0x01, .addr = 0x49, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_ACCM1] =		{.map = 0x01, .addr = 0x48, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_ACCM2] =		{.map = 0x01, .addr = 0x47, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_ACCM3] =		{.map = 0x01, .addr = 0x46, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_CNT0] =		{.map = 0x01, .addr = 0x4B, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_CNT1] =		{.map = 0x01, .addr = 0x4A, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_SLEEPCNT0] =	{.map = 0x01, .addr = 0x4D, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_SLEEPCNT1] =	{.map = 0x01, .addr = 0x4C, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_FG_HOSTEN] =		{.map = 0x01, .addr = 0x40, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_FG_RESET] =		{.map = 0x01, .addr = 0x41, .mask = 0x10, .ro = 0, .shift = 4},
	[PMU_REG_FG_CAL] =		{.map = 0x01, .addr = 0x41, .mask = 0x02, .ro = 0, .shift = 1},
	[PMU_REG_FG_FRZREAD] =		{.map = 0x01, .addr = 0x41, .mask = 0x20, .ro = 0, .shift = 5},
	[PMU_REG_FG_FRZSMPL] =		{.map = 0x01, .addr = 0x41, .mask = 0x40, .ro = 0, .shift = 6},
	[PMU_REG_FG_OFFSET0] =		{.map = 0x01, .addr = 0x54, .mask = 0xFF, .ro = 1, .shift = 6},
	[PMU_REG_FG_OFFSET1] =		{.map = 0x01, .addr = 0x55, .mask = 0xFF, .ro = 1, .shift = 6},
	...
	[PMU_REG_FG_CIC] =		{.map = 0x01, .addr = 0x43, .mask = 0xFF, .ro = 0, .shift = 0},
	/* usb control */
	[PMU_REG_OTG_VBUS_PULSE] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_OTG_VBUS_BOOST] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 2},
	[PMU_REG_OTG_VBUS_DISCHRG] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 1},
	...
	[PMU_REG_ADP_PRB_CYC_TIME] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 3},
	[PMU_REG_ADP_COMP_METHOD] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 5},
	[PMU_REG_ADP_ENABLE] =		{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 3},
	[PMU_REG_ADP_PRB_COMP] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_PRB_REG_RST] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	[PMU_REG_ADP_SNS_COMP] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 1},
	[PMU_REG_ADP_SNS_AON] =		{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 2},
	/* usb status */
	...
	[PMU_REG_OTG_STATUS_SESS_END] =		{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 2},
	[PMU_REG_ADP_STATUS_ATTACH_DET] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 3},
	[PMU_REG_ADP_STATUS_SNS_DET] =		{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	[PMU_REG_ADP_STATUS_RISE_TIMES_LSB] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 0},
	[PMU_REG_ADP_STATUS_RISE_TIMES_MSB] =	{.map = 0, .addr = 0, .mask = 0x00, .ro = 0, .shift = 4},
	/* BC ctrl and status */
	...
	/* bc */
	[PMU_REG_BC_STATUS_CODE] =		{.map = 0, .addr = 0x68, .mask = 0xFF, .ro = 1, .shift = 0},
	[PMU_REG_BC_STATUS_DONE] =		{.map = 0, .addr = 0x6A, .mask = 0x10, .ro = 1, .shift = 4},
	[PMU_REG_BC_STATUS_TO] =		{.map = 0, .addr = 0x69, .mask = 0x01, .ro = 1, .shift = 0},
	[PMU_REG_BC_CTRL_DET_RST] =		{.map = 0, .addr = 0x61, .mask = 0x01, .ro = 0, .shift = 0},
	[PMU_REG_BC_CTRL_DET_EN] =		{.map = 0, .addr = 0x61, .mask = 0x02, .ro = 0, .shift = 1},
	/* generic */
	[PMU_REG_SWUP] =		{.map = 0x00, .addr = 0x52, .mask = 0x04, .ro = 0, .shift = 2},
...
static const struct bcmpmu_irq_map bcm59039_irq_map[PMU_IRQ_MAX] = {
	...
	[PMU_IRQ_VBUS_1V5_F] =		{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x04},
	[PMU_IRQ_VBUS_4V5_F] =		{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x08},
	...
	[PMU_IRQ_ADP_SNS_END] =		{.int_addr = 0x34, .mask_addr = 0x44, .bit_mask = 0x20},
	[PMU_IRQ_SESSION_END_VLD] =	{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x04},
	[PMU_IRQ_SESSION_END_INVLD] =	{.int_addr = 0x33, .mask_addr = 0x43, .bit_mask = 0x40},
	[PMU_IRQ_VBUS_OVERCURRENT] =	{.int_addr = 0x37, .mask_addr = 0x47, .bit_mask = 0x80},
};

static const struct bcmpmu_env_info bcm59039_env_reg_map[PMU_ENV_MAX] = {
...
static const struct bcmpmu_adc_map bcm59039_adc_map[PMU_ADC_MAX] = {
	...
	[PMU_ADC_32KTEMP] =		{.addr0 = 0x93, .addr1 = 0x92,
					 .dmask = 0x3FF, .vmask = 0x0400,
					 .rtmsel = 0x08, .vrng = 1200},
...
static const struct bcmpmu_reg_map bcm59039_adc_ctrl_map[PMU_ADC_CTRL_MAX] = {
...
static const struct bcmpmu_reg_map bcm59039_irq_reg_map[PMU_IRG_REG_MAX] = {
