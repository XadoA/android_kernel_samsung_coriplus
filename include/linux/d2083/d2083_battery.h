...
#undef D2083_REG_JIG_IRQ
#define D2083_REG_TA_IRQ
#define D2083_REG_EOM_IRQ
#undef D2083_REG_TBAT1_IRQ
#undef D2083_REG_VDD_MON_IRQ
#undef D2083_REG_VDD_LOW_IRQ
#define D2083_REG_TBAT2_IRQ
#undef D2083_REG_VF_IRQ

// Battery capacity
#define BATTERY_CAPACITY_1300mAH
#undef  BATTERY_CAPACITY_1350mAH
#undef  BATTERY_CAPACITY_1500mAH
...
#define D2083_VOLTAGE_MONITOR_FAST_USB		(HZ*5)
...
#define D2083_SLEEP_MONITOR_WAKELOCK_TIME	(0.8*HZ)
...
#define BAT_CHARGING_RESTART_VOLTAGE		(4130)
...
// In order to set function pointer to get informcation from fuel gauge(TI)
int d2083_register_read_voltage(int (*read_voltage)(int *));
int d2083_register_read_soc(int (*read_soc)(int*));
int d2083_register_read_vf(int (*read_vf)(unsigned int *));
int d2083_register_fuelgauge_reset(int (*fuelgauge_reset)(void));
...
//void d2083_external_event_handler(int category, int event);
