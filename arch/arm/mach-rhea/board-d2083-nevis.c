...
struct d2083_platform_data d2083_pdata = {	
	...
	.regl_map = {
		...
		*/
		...
		D2083_MCTL_MODE_INIT(D2083_LDO_2,  0x54, D2083_REGULATOR_OFF_IN_DSM),	// VRF_2.7V
		...
		D2083_MCTL_MODE_INIT(D2083_LDO_8,  0x54, D2083_REGULATOR_MAX),			// VLCD_3.0V
		...
		D2083_MCTL_MODE_INIT(D2083_LDO_14, 0x44, D2083_REGULATOR_OFF_IN_DSM),	// VTOUCH_1.8V
		D2083_MCTL_MODE_INIT(D2083_LDO_15, 0x44, D2083_REGULATOR_OFF_IN_DSM),	// VTOUCH_3.3V
		...
		D2083_MCTL_MODE_INIT(D2083_LDO_AUD,0x00, D2083_REGULATOR_OFF_IN_DSM),	// Inter Audio LDO
	},
};
...
#define CSR_VAL_NRML_SS_1G		0x1B /*1.16V -> 1.175V*/
#define CSR_VAL_NRML_TT_1G		0x16 /*1.04V -> 1.050V*/
#define CSR_VAL_NRML_FF_1G		0x14 /*0.98V -> 1.00V*/
...
#define CSR_VAL_TURBO_FF_1G		0x1E /*1.24V -> 1.25V*/
#else
/*1 Ghz CSR voltage definitions....*/
